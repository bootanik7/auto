...
public class CopyOfErm_PayYourBillNow_Card_Page 
{   
	 /**
    ...
    {
    	 CopyOfErm_PayYourBillNow_Card_Page.Enter_Card_Num(Ed.get("CARD_NUMBER"));
		 CopyOfErm_PayYourBillNow_Card_Page.click_on_Continue();
