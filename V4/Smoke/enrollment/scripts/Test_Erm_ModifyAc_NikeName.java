 ...
 *
 */
public class Test_Erm_ModifyAc_NikeName
{
	 ...
	 public static void setUp() throws InterruptedException, ClassNotFoundException, SQLException
		{
			...
			Log.gsScriptDescription = "Tests ModifyAc_nickname from MAM";
			...
			Log.initialize();
			Log.logBanner("Setup for ModifyAc_nickname testcase for MAM");
	 ...
	 * @throws InterruptedException
	 */
	public void Erm_ModifyAc_NikeName_Test(Map<String,String> Ed) throws InterruptedException
	{   
    ...
    Erm_ModifyAc_NikeName_Test(getdetails);
