 ...
 *
 */
public class Regress_V4_CC_ACH_PaymentRoutingNumberTestCase {
	static Map<String, Connection> conn = null;

	// fieldName must exist in V4_CC_Payment.mapRecord
		static String fieldName = "bankAccount.routingNumber";
	...
	*/
	...
	// MAM 
	@Test
	public void createPaymentWithoutRoutingNumber_MAM()
			throws ClassNotFoundException, SQLException, InterruptedException {
		checkType = "routingnumberrequired";
		...
		Log.startTestCase(
				"Verify payment can not be happened with empty mandatory Routing Number field value for MAM biller");
	...
	@Test
	public void createPaymentWithNonValidRoutingNumber_MAM()
			throws ClassNotFoundException, SQLException, InterruptedException {
		...
		Log.startTestCase(
				"Verify payment can not be happened without inserting valid Routing Number field value for MAM biller mask");
